...
Do not remove a constraint merely because a newer model seems capable without it. Shared guidance can serve multiple models. Treat claims of improved behavior as hypotheses until paired trials support them; use [evaluate.md](evaluate.md) only when preparing or conducting that evaluation.
