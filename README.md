...
```sh
uvx agent-baseline@0.4.0 init . --agent codex --agent claude
```
...
```sh
uvx agent-baseline@0.4.0 skill show
```
...
```sh
uvx agent-baseline@0.4.0 skill show --file SKILL.md
uvx agent-baseline@0.4.0 skill show --file references/audit.md
```
...
```sh
uvx agent-baseline@0.4.0 doctor .
uvx agent-baseline@0.4.0 check .
uvx agent-baseline@0.4.0 verify .
```
...
```sh
uvx agent-baseline@0.4.0 record .
uvx agent-baseline@0.4.0 verify .
```
...
```sh
uvx agent-baseline@0.4.0 skill link tooling/skills/team-engineering --agent codex --agent claude
```
...
```sh
uvx agent-baseline@0.4.0 skill install --agent codex --scope user
```
...
```sh
uvx agent-baseline@0.4.0 skill install --agent codex --scope user --upgrade
```
